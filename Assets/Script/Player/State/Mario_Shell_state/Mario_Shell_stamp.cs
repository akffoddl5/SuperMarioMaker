...
public class Mario_Shell_stamp : Mario_Shell_State
{
    public float jumpMoveSpeed;
    float last_velocity_y = 0;

    public Mario_Shell_stamp(Mario _mario, Mario_stateMachine _stateMachine, string _animBoolName) : base(_mario, _stateMachine, _animBoolName)
    {
    }
