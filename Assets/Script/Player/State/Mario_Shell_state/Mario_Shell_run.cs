...
public class Mario_Shell_run : Mario_Shell_State
{
	...
	public Mario_Shell_run(Mario mario, Mario_stateMachine stateMachine, string animBool) : base(mario, stateMachine, animBool)
	{
	}
	...
	public override void Update()
	{
		...
		{
			if (run_rate > 1.4f)
				stateMachine.ChangeState(mario.mario_Shell_Slide);
			else
